...
namespace vkpixel {
    ...
    Image::Image(const VkPixelDevice::Ptr &device,
                 const int& width,
                 const int& height,
        ...
        imageCreateInfo.imageType = imageType; //2d or 3D
        ...
        imageCreateInfo.samples = sample; //采样数, 抗锯齿会用到这个参数
        imageCreateInfo.mipLevels = 1;
        imageCreateInfo.arrayLayers = 1; //包含多少个layer, 一张图片包含多少个真正的图片
