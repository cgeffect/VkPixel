//
//  VkPixelSwapChain.cpp
//  VkPixel
//
//  Created by Jason on 2022/4/21.
//

#include "VkPixelSwapChain.h"

namespace vkpixel {
    
VkPixelSwapChain::VkPixelSwapChain(const VkPixelDevice::Ptr& device, const VkPixelWindow::Ptr& window, const VkPixelSurface::Ptr& surface) {
    mDevice = device;
    mWindow = window;
    mSurface = surface;
...
VkPixelSwapChain::~VkPixelSwapChain() {
...
SwapChainSupportInfo VkPixelSwapChain::querySwapChainSupportInfo() {
...
VkSurfaceFormatKHR VkPixelSwapChain::chooseSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR VkPixelSwapChain::chooseSurfacePresentMode(const std::vector<VkPresentModeKHR>& availablePresenstModes) {
...
VkExtent2D VkPixelSwapChain::chooseExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
VkImageView VkPixelSwapChain::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels) {
