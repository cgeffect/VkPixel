...
VkPixelInstace::VkPixelInstace(bool enableValidationLayer) {
...
void VkPixelInstace::printAvailableExtensions() {
...
std::vector<const char*> VkPixelInstace::getRequiredExtensions() {
...
bool VkPixelInstace::checkValidationLayerSupport() {
...
void VkPixelInstace::setupDebugger() {
